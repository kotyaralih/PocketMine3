...
class NpcDialoguePacket extends DataPacket/* implements ClientboundPacket*/{
	...
	protected function decodePayload() : void{
		$this->npcActorUniqueId = (Binary::readLLong($this->get(8))); //WHY NOT USING STANDARD METHODS, MOJANG
	...
	protected function encodePayload() : void{
		($this->buffer .= (\pack("VV", $this->npcActorUniqueId & 0xFFFFFFFF, $this->npcActorUniqueId >> 32)));
